...
\begin{salt_example}[$\exp$, $\sin$, $\cos$은 전해석함수이다] \label{example-2-8}
...
\begin{salt_example}[$\Log$의 복소미분가능성] \label{example-2-9}
...
\begin{salt_example}\label{example-2-10}
...
\begin{salt_example}[절대값이 일정한 복소미분가능 함수는 상수함수이다]\label{example-2-11}
...
\begin{salt_example} \label{example-2-12}
...
\begin{salt_example}[켤레복소수 함수는 어떤 점에서도 복소미분이 불가능하다]
\label{example-2-13}
...
\begin{salt_example}\label{example-2-14}
...
\begin{salt_example}\label{example-2-15}
...
\begin{salt_example}\label{example-2-16}
$z^2$은 전해석함수이다. 왜냐하면,
\begin{align*}
