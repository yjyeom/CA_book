...
\begin{saltprop}[]{prop-2-1} %\label{prop-2-1}
...
\begin{saltprop}[연쇄법칙]{prop-2-2} %\label{prop-2-2} 
\begin{itemize}
...
\begin{saltexample}{전해석함수} {} \label{example-2-8}
...
\begin{saltexample}{복소미분가능성}{} \label{example-2-9}
