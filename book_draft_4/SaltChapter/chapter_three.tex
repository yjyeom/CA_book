...
\begin{saltprop}[]{prop-3-1} %\label{prop-3-1}
...
\begin{saltprop}[]{prop-3-2} %\label{prop-3-2}
...
\begin{saltprop}[]{prop-3-3} %\label{prop-3-3}
...
\begin{saltprop}[] {prop-3-4} %\label{prop-3-4}
\begin{itemize}
...
\end{center}
\captionof{figure}{경로 $\gamma$의 길이는 국소적인 곡선 길이 $ds$의 합이고,
...
\begin{saltexample}{}{} \label{example-2-8}
...
\begin{saltprop}[]{prop-3-5} %\label{prop-3-5}
\begin{itemize}
