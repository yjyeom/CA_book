...
})이라 부른다. \index{복소해석적(holomorphic)}
\item[(3)] 복소수 $\mathbb C$ 전체에서 복소해석적이면 
\textbf{전해석 함수}(entire function)\index{전해석 함수(entire function)}라 부른다. 즉, $f$의 정의역이 복소수 $\mathbb C$ 전체이고
...
$f$를 복소해석함수(analytic function)\index{복소해석함수(analytic function)} 라고도 한다.
...
%\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.9\textwidth]{./SaltChapter/figs/fig-2-2}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.7\textwidth]{./SaltChapter/figs/fig-2-3}
\end{center}
...
%\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.9\textwidth]{./SaltChapter/figs/fig-2-4}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.7\textwidth]{./SaltChapter/figs/fig-2-5}
\end{center}
\caption{$f$의 실수부 $u$와 허수부 $v$}
\label{fig-2-5}
\end{figure}
...
이 방정식을 \textbf{코시-리만 방정식}\index{코시-리만 방정식(Cauchy-Riemann equations)}이라 부른다.
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.35\textwidth]{./SaltChapter/figs/fig-2-6}
\end{center}
...
연습문제 \ref{ex-2-1}에서 주어진
$f$는 열린집합 $\mathbb C\setminus \{0\}$의 모든 점에서 미분가능하지 않음을 보여라.
\end{salt_exercise}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.7\textwidth]{./SaltChapter/figs/fig-2-7}
\end{center}
...
\begin{saltexample}[label=example-2-8]{전해석 함수 $\exp$, $\sin$, $\cos$}{}
...
\]
가 되어 모순이 생긴다. 따라서 $f$는 $0$에서 복소미분가능하지 않다.
...
%\begin{figure*}[!h]
\begin{center}
\includegraphics[width=0.7\textwidth]{./SaltChapter/figs/fig-2-0-2}
\end{center}
%\end{figure*}
...
%\begin{figure*}[!h]
\begin{center}
\includegraphics[width=0.3\textwidth]{./SaltChapter/figs/fig-2-0-3}
\end{center}
%\end{figure*}
...
미분 $f'(x_0)$에 대한 기하학적 의미는 $x_0$점에서 $f$의 그래프에 접하는 접선의 기울기임을
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.7\textwidth]{./SaltChapter/figs/fig-2-9}
\end{center}
...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.7\textwidth]{./SaltChapter/figs/fig-2-10}
\end{center}
...
%\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.8\textwidth]{./SaltChapter/figs/fig-2-11}
\end{center}
...
%\begin{figure}[!h]
\begin{center}
\includegraphics[width=0.8\textwidth]{./SaltChapter/figs/fig-2-12}
\end{center}
\captionof{figure}{제곱함수에 의한 국소 확대 배율의 계산}
\label{fig-2-12}
%\end{figure}
\saltfigskip   %===20230215
...
두 개의 식으로 된 코시-리만 방정식은 다음 ``d-bar 연산자''\index{d-bar 연산자(d-bar operator)} 개념을 도입하면
단일 방정식으로 쓸 수 있다.
\[
